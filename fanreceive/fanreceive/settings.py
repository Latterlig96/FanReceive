...
if "ELASTICACHE_URL_BACKEND" in os.environ:
    CELERY_BROKER_URL = os.environ["ELASTICACHE_URL_BACKEND"]
    CELERY_RESULT_BACKEND = os.environ["ELASTICACHE_URL_RESULT_BACKEND"]
else:
